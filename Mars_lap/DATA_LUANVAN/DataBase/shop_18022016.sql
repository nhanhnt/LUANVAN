...
-- Dumping data for table shoponline.chitiethoadon: ~3 rows (approximately)
DELETE FROM `chitiethoadon`;
/*!40000 ALTER TABLE `chitiethoadon` DISABLE KEYS */;
INSERT INTO `chitiethoadon` (`id_chitiethoadon`, `id_hoadon`, `id_sanpham`, `soluong`, `dongia`, `giamgia`, `created`) VALUES
	(6, 14, 1, 2, 319000, 41, '2016-02-18 21:13:08'),
	(7, 14, 3, 1, 319000, 0, '2016-02-18 21:13:13'),
	(8, 14, 6, 1, 659000, 0, '2016-02-18 22:00:58');
...
DELIMITER //
CREATE DEFINER=`luanvan`@`localhost` FUNCTION `func_update_hoadon`(`rq_id_hoadon` INT, `rq_diachigiaohang` TEXT, `rq_phuongthucthanhtoan` TEXT, `rq_ngaygiaohang` TIMESTAMP, `rq_phiship` DOUBLE) RETURNS text CHARSET utf8
BEGIN
	#select func_update_hoadon(10,"93 Nguyễn Trãi","Nhận hàng lấy tiền","2016-02-19",19200);
	DECLARE r_res TEXT;
...
-- Dumping data for table shoponline.hoadon: ~1 rows (approximately)
DELETE FROM `hoadon`;
...
INSERT INTO `hoadon` (`id_hoadon`, `id_taikhoan`, `diachigiaohang`, `phuongthucthanhtoan`, `ngaygiaohang`, `ngaymuahang`, `phiship`, `status`, `checkhang`) VALUES
	(14, 10, '', '', '2016-02-18 21:12:51', '2016-02-18 21:12:51', 0, 0, 0);
/*!40000 ALTER TABLE `hoadon` ENABLE KEYS */;


-- Dumping structure for procedure shoponline.pro_getcart
DELIMITER //
CREATE DEFINER=`luanvan`@`localhost` PROCEDURE `pro_getcart`(IN `rq_id_hoadon` INT)
BEGIN
	#call pro_getcart(10)
	select sanpham.id_sanpham,chitiethoadon.id_chitiethoadon,taikhoan.tentaikhoan,sanpham.hinhanh,sanpham.tensanpham,chitiethoadon.soluong,
		FORMAT(chitiethoadon.dongia,0) as 'dongia',chitiethoadon.giamgia,hoadon.diachigiaohang,hoadon.phuongthucthanhtoan,hoadon.ngaygiaohang,
