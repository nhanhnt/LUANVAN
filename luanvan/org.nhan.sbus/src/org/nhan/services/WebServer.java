...
protected void loadServlets(String extensionPoint) {
        IConfigurationElement[] extensions = ExtPointUtil.getConfigElements(extensionPoint);
        ...
        for (IConfigurationElement conElServlet:extensions) {
            try {
                Servlet servletClass = (javax.servlet.Servlet)conElServlet.createExecutableExtension("class");
                String servletName = conElServlet.getAttribute("name");
                
                // Find mappings
                IConfigurationElement[] conElMappings = conElServlet.getChildren();
...
protected void loadWebServices(String extensionPoint) {
        ...
        for (IConfigurationElement conElWebs:extensions) {
            try {
            	...
            	MessageHandler.log("Can't deploy web service: "+conElWebs, exp);
            }
        }
	}
